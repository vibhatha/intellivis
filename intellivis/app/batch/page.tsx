...
import BatchDataEntry from '../components/BatchDataEntry';
      ...
      <nav className="relative z-10 px-6 py-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center space-x-6">
            ...
            <a href="/explore" className="text-gray-300 hover:text-white transition-colors duration-200">
              Explore
            </a>
            <a href="/batch" className="text-orange-400 font-medium">
              Batch
            </a>
          </div>
        </div>
